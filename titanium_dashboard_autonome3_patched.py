"""
Titanium Dashboard v6 — AUTONOME + Vision locale Ollama (SMC LIVE)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
OPT_CONFIGURATIONS: List[Dict[str, Any]] = [
    # atr_mult faibles — SL serré, TPs agressifs
    {"atr_mult": 0.5,  "tp_ratios": (1.2, 1.8, 2.4), "trailing": False},
    {"atr_mult": 0.5,  "tp_ratios": (1.5, 2.1, 2.8), "trailing": False},
    # atr_mult intermédiaires — équilibre risque/rendement
    {"atr_mult": 0.7,  "tp_ratios": (1.2, 1.8, 2.4), "trailing": False},
    {"atr_mult": 0.7,  "tp_ratios": (1.5, 2.1, 2.6), "trailing": False},
    {"atr_mult": 0.7,  "tp_ratios": (1.8, 2.3, 2.9), "trailing": False},
    # atr_mult standard (correspond aux valeurs live par défaut)
    {"atr_mult": 1.0,  "tp_ratios": (1.2, 1.8, 2.4), "trailing": False},
    {"atr_mult": 1.0,  "tp_ratios": (1.5, 2.1, 2.6), "trailing": False},
    {"atr_mult": 1.0,  "tp_ratios": (1.8, 2.3, 2.9), "trailing": False},
    # atr_mult larges — SL confortable, TPs conservateurs
    {"atr_mult": 1.3,  "tp_ratios": (1.2, 1.8, 2.4), "trailing": False},
    {"atr_mult": 1.3,  "tp_ratios": (1.5, 2.1, 2.6), "trailing": False},
    {"atr_mult": 1.5,  "tp_ratios": (1.2, 1.8, 2.4), "trailing": False},
    {"atr_mult": 1.5,  "tp_ratios": (1.8, 2.3, 2.9), "trailing": False},
]
...
VISION_MODEL_FALLBACK = os.getenv("VISION_MODEL_FALLBACK", "qwen2.5vl:3b-q4_K_M")
